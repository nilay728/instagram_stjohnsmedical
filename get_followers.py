...
options.add_extension("/Users/gyanprakash/Downloads/instagram_stjohnsmedical/extension.crx")
...
for i,account in enumerate(to_get_followers):
    ...
    try:
        ...
        time.sleep(10)
        try:
            os.system('mv /Users/gyanprakash/Downloads/{}_followers.csv /Users/gyanprakash/Downloads/instagram_stjohnsmedical/accounts'.format(account))
        except:
